...
import { useNivel } from "../../contexts/NivelContext.jsx"
...
export default function RecompensasPage() {
  ...
  const setNivelContext = useNivel();


  const [toastMSG, setToastMSG] = useState("");
  const handleResgatarTudo = () => {
    setToastMSG(`Recompensa Resgatada Com Sucesso`);
    setTimeout(() => setToastMSG(null), 3000);

    setPontos(pontos + 750);
